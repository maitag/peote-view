...
/**
	BMFont provides the data for `BMFontData`.  
	It embedds a 8x8 pixels monospace bitmapfont, borrowed from good old @see <a href="https://code.haxe.org/category/other/vga-text-renderer.html">haxe cookbook</a>
**/
class BMFont {
	
	/**
		The data of the font in hex bytes notation
	**/
	static public var data:Array<Int> = [
		...
		0x00, 0x18, 0x3C, 0x7E, 0xFF, 0xFF, 0x00, 0x00, // 030  0x1E  R    Record Separator
		0x00, 0xFF, 0xFF, 0x7E, 0x3C, 0x18, 0x00, 0x00, // 031  0x1F  U    Unit Separator
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 032  0x20  S    Space
		...
		0x00, 0x10, 0x38, 0x6C, 0xC6, 0xC6, 0xFE, 0x00  // 127  0x7F  D    Delete
	];
}    