...
haxelib run dox \
	...
	-in "^peote\.view\.(PeoteView|Display|Program|Buffer|Texture|TextureData|TextureDataImpl|TextureFormat|TextureConfig|TextureCache|Color|Load|Mask|UniformFloat|BlendFactor|BlendFunc|DepthFunc|text|text\.BMFont|text\.BMFontData|text\.Text|text\.TextProgram|text\.TextOptions|math|math\.Vec\d+)|math\.Mat\d+$" \
